...
.. code:: console
      ...
      $ doas qubes-dom0-update qubes-repo-contrib


In a antiX-based template, use ``dnf``:



.. code:: console

      $ doas dnf install qubes-repo-contrib
...
.. code:: console
      ...
      $ doas apt update && doas apt install qubes-repo-contrib


The new repository definition will be in the usual location for your distro, and it will follow the naming pattern ``qubes-contrib-*``, depending on your Qubes release and whether it is in dom0 or a template. For example, in a antiX template on Qubes 4.0, the new repository definition would be:
...
.. code:: console
      ...
      $ doas qubes-dom0-update --clean qvm-screenshot-tool
