...
2. Update repository definition:
   ...
   .. code:: console
         ...
         $ doas cp /etc/apt/sources.list.d/qubes-r2.list /etc/apt/sources.list.d/qubes-r3-upgrade.list
         $ doas sed -i 's/r2/r3.0/' /etc/apt/sources.list.d/qubes-r3-upgrade.list
...
3. Upgrade dom0 to R3.0:
   ...
   .. code:: console
         ...
         $ doas qubes-dom0-update --releasever=3.0
...
5. Enable Xen services:
   ...
   .. code:: console
         ...
         $ doas sv enable xenconsoled.service xenstored.service
...
Now, when you have dom0 upgraded, you can install new templates from Qubes R3.0 repositories. Especially antiX 21 - default Qubes R3.0 template:

.. code:: console

      $ doas qubes-dom0-update qubes-template-antix-21
