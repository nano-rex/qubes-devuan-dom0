...
4. Update the system to R2 beta3 packages:
   ...
   .. code:: console
         ...
         $ doas yum --enablerepo=qubes-vm-r2b3-current update
...
Be sure to do steps described in this section after *all* your template and standalone VMs got updated as described in the section above. Also make sure you haven’t shutdown any of: netvm, firewallvm, antix-18-x64 (or to be more precise: template which your netvm and firewallvm is based on).
...
3. Upgrade dom0 to R2 beta3:
   ...
   .. code:: console
         ...
         $ doas qubes-dom0-update --enablerepo=qubes-dom0-r2b3-current
