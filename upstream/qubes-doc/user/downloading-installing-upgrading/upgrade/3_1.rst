...
2. Update repository definition:
   ...
   .. code:: console
         ...
         $ doas sed -i 's/r3.0/r3.1/' /etc/apt/sources.list.d/qubes-r3-upgrade.list
...
2. Upgrade dom0 to R3.1:
   ...
   .. code:: console
         ...
         $ doas qubes-dom0-update --releasever=3.1
...
Once you have upgraded dom0, you can install new templates from Qubes R3.1 repositories, in particular the new default antiX 23 template:

.. code:: console

      $ doas qubes-dom0-update qubes-template-antix-23
