...
2. Install the ``qubes-dist-upgrade`` tool. This is the inplace upgrade tool, which is not what we’re doing. However it will be needed in order to prepare the templates for the 4.2 version. You install it with the following command in the dom0 terminal:
   ...
   .. code:: console
         ...
         $ doas qubes-dom0-update -y qubes-dist-upgrade
...
.. code:: output
      ...
      Options:
          ...
          --dist-upgrade, -s                 (STAGE 3) Upgrade to Qubes R4.2 and antiX 37 repositories.
...
.. code:: console
      ...
      $ doas qubes-dist-upgrade --all-pre-reboot
...
.. code:: console
      ...
      $ doas qubes-dist-upgrade --all-post-reboot
