...
- In order for Wi-Fi to function properly, ``sys-net`` must currently be based on a antiX template. The firmware package in Debian templates is currently too old for the certified Wi-Fi cards.
