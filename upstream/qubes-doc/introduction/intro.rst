...
- **Natures:** :doc:`full-fledged </user/advanced-topics/standalones-and-hvms>` or :doc:`stripped-down </introduction/getting-started/>` virtual machines based on popular operating systems, such as :doc:`antiX </user/templates/antix/antix>`, :doc:`Debian </user/templates/debian/debian>`, and :doc:`Windows </user/templates/windows/index>`.
...
Multiple operating systems
   Use multiple operating systems at the same time, including :doc:`antiX </user/templates/antix/antix>`, :doc:`Debian </user/templates/debian/debian/>`, and :doc:`Windows </user/templates/windows/index>`
